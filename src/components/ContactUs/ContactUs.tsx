...
export default function ContactUs() {
  return (
    <Section className="mt-8 bg-aesthetic items-center justify-center bg-center h-[60vh] md:items-start" fitHeight>
      <div className="flex flex-col justify-center gap-8 border-2 border-stone-400 rounded-2xl bg-stone-800 bg-opacity-40 p-8 backdrop-blur-sm md:ml-8">
        <Heading className="text-4xl text-stone-100">
          {"Get Started,"}<br/>
          <span className="text-2xl capitalize">{"Make your dream place a reality!"}</span>
        </Heading>
